...
# original picture
image = cv.imread('Images/at.jpeg')
image = cv.cvtColor(image, cv.COLOR_BGR2RGB)

# show original picture
plt.figure(num='Orijinal Resim')
plt.axis("off")
plt.imshow(image)

# show task 1 : detect object
classA = A()
classA.object('Images/at.jpeg')
...
# show task 4
image1 = Image.open('Images/at.jpeg')
